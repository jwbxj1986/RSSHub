...
const { lazyloadRouteHandler } = require('./utils/router-decorators');
...
//新疆医科大学岗位
router.get('/xjmu/zhaopin', lazyloadRouteHandler('./routes/xjmu/zhaopin.js'));
router.get('/xjmu/debug', lazyloadRouteHandler('./routes/xjmu/debug.js'));
// Deprecated: DO NOT ADD ANY NEW ROUTES HERE
